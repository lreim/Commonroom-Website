...
class PageVisit(db.Model):
    ...
    tracking_version = db.Column(db.Integer, nullable=True, index=True)
    acquisition_source = db.Column(db.String(80), nullable=True, index=True)
    acquisition_medium = db.Column(db.String(40), nullable=True, index=True)
    acquisition_campaign = db.Column(db.String(100), nullable=True)
