...
class Config:
    ...
    TALKTO_REPORT_EMAIL = os.environ.get('TALKTO_REPORT_EMAIL') or 'report-abuse@commonroom.ch'
    POSTMARK_MESSAGE_STREAM_REPORT = os.environ.get('POSTMARK_MESSAGE_STREAM_REPORT', 'outbound')
